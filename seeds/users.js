...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('users').insert({fullName: 'Tony Luisi', passwordHash: bcrypt.hashSync('password', saltRounds), email: 'tluisi@gmail.com', styleRating: 3, connoisseurRating: 3, fbId: 10156915534565451, igId: 4}),
    knex('users').insert({fullName: 'Mix Irving', passwordHash: bcrypt.hashSync('password', saltRounds), email: 'mix@gmail.com', styleRating: 3, connoisseurRating: 3, fbId: 10156915534565452, igId: 5})
  );
};
