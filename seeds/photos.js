...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('photos').insert({userId: 5, countryId: 171, cityId: 4, caption: 'Im Mix', rating: 76, link: "http://b-i.forbesimg.com/eliseackerman/files/2013/07/300px-Linus_Torvalds_flipped4.jpg", categoryId: 7, created_at: "1999-01-08 04:05:06", updated_at: "1999-01-08 04:05:06"}),
    knex('photos').insert({userId: 5, countryId: 171, cityId: 4, caption: 'Im Mix', rating: 76, link: "https://upload.wikimedia.org/wikipedia/commons/2/2f/Linus_Torvalds_talking.jpeg", categoryId: 7, created_at: "1999-01-08 04:05:06", updated_at: "1999-01-08 04:05:06"}),
    knex('photos').insert({userId: 2, countryId: 171, cityId: 4, caption: 'Im Sam', rating: 76, link: "https://static.pexels.com/photos/6980/summer-cute-hipster-beauty.jpg", categoryId: 1, created_at: "1999-01-08 04:05:06", updated_at: "1999-01-08 04:05:06"}),
    knex('photos').insert({userId: 2, countryId: 171, cityId: 4, caption: 'Im Sam too', rating: 76, link: "http://media2.popsugar-assets.com/files/2014/04/14/605/n/1922564/99c1a707a532838a_484550455.xxxlarge_2x/i/Kate-Middleton-New-Zealand.jpg", categoryId: 4, created_at: "1999-01-08 04:05:06", updated_at: "1999-01-08 04:05:06"}),
